...
void imuInfo(){
  ...
  jsonInfoSend["temp"] = getIMUTemp(); //QMI8658_readTemp();

  jsonInfoSend["roll"] = stAngles.roll;
  jsonInfoSend["pitch"] = stAngles.pitch;
  jsonInfoSend["yaw"] = stAngles.yaw;

  jsonInfoSend["acce_X"] = stAccelRawData.X;
  jsonInfoSend["acce_Y"] = stAccelRawData.Y;
  jsonInfoSend["acce_Z"] = stAccelRawData.Z;

  jsonInfoSend["gyro_X"] = stGyroRawData.X;
  jsonInfoSend["gyro_Y"] = stGyroRawData.Y;
  jsonInfoSend["gyro_Z"] = stGyroRawData.Z;
